namespace Bloggable.Common.Constants
{
    ...
    {
        public const string Web = "Bloggable.Web";

        public const string WebModels = "Bloggable.Web.Models";

        public const string WebInfrastructure = "Bloggable.Web.Infrastructure";

        public const string ServicesAdministration = "Bloggable.Services.Administration";

        public const string ServicesData = "Bloggable.Services.Data";
    }
}
